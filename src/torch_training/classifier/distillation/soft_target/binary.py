...
from torch_training.losses.ce_distillation_loss import BCEDistillationLoss
...
def train_model(
    ...
    return train_classifier(
        ...
        loss_fn=BCEDistillationLoss(temperature, soft_target_weight),
...
def _forward_pass_fn(
    ...
    student_predictions = sigmoid(student_logits)
